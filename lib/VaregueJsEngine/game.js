...
const snake_CanvasComponent_1 = require("../snake/snake.CanvasComponent");
const Snake_GameArea_1 = require("../snake/Snake.GameArea");
const globals_1 = require("./globals");
const snake_Fruit_CanvasComponent_1 = require("../snake/snake.Fruit.CanvasComponent");
const args_1 = require("./args");
const SmartDumbIaController_1 = require("../snake/SmartDumbIaController");
class gameMain {
    async start() {
